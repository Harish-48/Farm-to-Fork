...
<body>
	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
					<div class="card-header" style="background: linear-gradient(45deg, #DAA520, #8B0000); /* Warm Gold to Deep Burgundy */"><h4 style="font-style:bold;color:#FFF">Register</h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="BuyerRegistration.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary"  style="background-color:orange;color:white" name="register" value="Register">
										Register
									</button>
								</div>
							</form>
    ...
    <div class="footer">
        &copy; 2024 Farm2Fork. All rights reserved.
    </div>
</body>
