...
<br>
    ...
    <div class="container" >
        ...
        <a href="BuyerEditProfile.php"><button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:goldenrod">Edit Profile</button></a>
    </div>
