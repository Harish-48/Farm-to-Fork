...
<nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <div class="p-2">
                <div class="icon2">
                    <a href="CartPage.php"> <i class="fa" style="font-size:30px; color:white; margin-top:2px;">&#61562;</i></a>
            ...
            while ($rows = mysqli_fetch_array($runa_query)) {
                ...
                <div class='container'>
                    <div class='text-center'>
                        <br>
                        <h1 id='headings' class='font-weight-bold' style='color:orange;'>$product_title</h1>
                    </div>
                    <br>
                    ...
                    <div class='  description mt-0'><b>
                            <h2 class='text-center font-weight-bold' style='color:orange'>Description</h2>
                        </b></div>
                    <br>
