    ...
    margin-left:10px;
        ...
        @media only screen and (min-device-width:320px) and (max-device-width:480px) {
            ...
            .guard {
                ...
                text-align: center;
                border-bottom: 1px solid #ffc857;
                background-color: linear-gradient(45deg, #DAA520, #8B0000); 
                /* line-height: 0.1em; */
                /* margin: 10px 0 20px; */
                /* font-family: serif; */
...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse right ">
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                        ...
                        echo "<a href='<a href='http://localhost:5000/' class='dropdown-item' style='padding-right:-20px;' >Chat with us</a>";
            ...
            <div class="text-light  login">Login</div>
        </div>

    </nav>

    <!-- Chat Button -->
<a href="http://localhost:5000/"><button class="chat-btn" onclick="toggleChatPopup()">Get ur Ingredients!</button></a>
    <div class="container">
        <div class="d-flex justify-content-around bg-black mb-3">

            <div class="p-2 ">
                <div class="dropdown">
                    <button class="btn btn-white mybtn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Fruits
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <?php
    ...
    <div class="container"> <img src="Body.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
